...
export default function LandingPage({
  ...
  return (
    <main className="relative flex min-h-screen w-full flex-col bg-slate-950 overflow-hidden font-sans select-none">
      {/* 1. Full-Bleed 3D Digital Twin Hero Background */}
      <div className="absolute inset-0 z-0 h-full w-full">
        <CinematicCityFlythrough />
      </div>

      {/* 2. Atmospheric Dark Vignette Overlay for Readability */}
      <div className="pointer-events-none absolute inset-0 z-10 bg-gradient-to-b from-slate-950/70 via-transparent to-slate-950/90" />
      <div className="pointer-events-none absolute inset-0 z-10 bg-[radial-gradient(ellipse_40%_50%_at_50%_45%,_#020617_0%,_transparent_100%)] opacity-70" />
